...
public class IcsBuilder {
  ...
  private static final DateTimeFormatter ICS_DT_FORMAT =
      DateTimeFormatter.ofPattern("yyyyMMdd'T'HHmmss'Z'");

  public static String buildIcsEvent(
      Lesson lesson, List<String> attendeesEmails, String organizerEmail, String uid) {

    var startUtc =
        lesson.getStartTime().atZone(ZoneId.systemDefault()).withZoneSameInstant(ZoneId.of("UTC"));
    var endUtc =
        lesson.getEndTime().atZone(ZoneId.systemDefault()).withZoneSameInstant(ZoneId.of("UTC"));
    ...
    sb.append("DTSTAMP:")
        .append(ICS_DT_FORMAT.format(java.time.Instant.now().atZone(ZoneId.of("UTC"))))
        .append("\r\n");
    ...
    sb.append("DESCRIPTION:")
        .append(escape(lesson.getDescription()))
        .append("\\nLink da reunião: ")
        .append(meetLink)
        .append("\r\n");
