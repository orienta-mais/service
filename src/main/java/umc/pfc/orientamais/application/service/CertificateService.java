  ...
  public GenericModelResponse validatePresenceAndGenerateCertificate(
    ...
    String content =
        "<p>Olá, "
            + mentored.getName()
            + "!</p>"
            + "<p>Segue em anexo seu certificado de participação na aula <strong>"
            + lesson.getTitle()
            + "</strong>.</p>"
            + "<p>Equipe Orienta+</p>";

    emailSender.sendEmailWithAttachment(
        mentored.getUser().getEmail(), subject, content, "certificado.pdf", pdf);

    return new GenericModelResponse(
        "CERTIFICATE_GENERATED", "Certificado gerado e enviado com sucesso!");
  }
  ...
  public GenericModelResponse regenerateCertificate(UUID lessonId) {
    ...
    if (!lessonMentored.isCertificateGenerated()) {
      throw new BadRequestException(
          "O certificado ainda não foi gerado. Valide o código de presença primeiro");
    }
    ...
    String content =
        "<p>Olá, "
            + mentored.getName()
            + "!</p>"
            + "<p>Segue novamente seu certificado da aula <strong>"
            + lesson.getTitle()
            + "</strong>.</p>"
            + "<p>Equipe Orienta+</p>";
    ...
    return new GenericModelResponse(
        "CERTIFICATE_REGENERATED", "Certificado reenviado com sucesso!");
  }
}
