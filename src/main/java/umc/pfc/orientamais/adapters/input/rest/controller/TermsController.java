...
public class TermsController {
  ...
  public ResponseEntity<TermsAndPrivacyResponse> getActiveTerm(@PathVariable TermType type) {
  ...
  public ResponseEntity<String> getActiveTermHtml(@PathVariable TermType type) {
  ...
  public ResponseEntity<List<TermsAndPrivacyResponse>> getAllVersions(@PathVariable TermType type) {
  ...
  public ResponseEntity<TermsAndPrivacyResponse> getTermByVersion(
      @PathVariable TermType type, @PathVariable Integer version) {
  ...
  public ResponseEntity<TermsAndPrivacyResponse> activateVersion(
      @Parameter(description = "Type of term (TERMS/terms or PRIVACY/privacy - case insensitive)")
          @PathVariable
          TermType type,
