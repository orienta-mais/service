...
public record UserRegisterModelRequest(
  ...
  @NotBlank(message = "Este campo é obrigatório!")
  @Pattern(regexp = "^[a-zA-ZÀ-ÿ\\s'\\-]{2,100}$", message = "Nome inválido. Use apenas letras, espaços, hífens e apóstrofos")
  @Size(min = 2, max = 100, message = "Nome deve ter entre 2 e 100 caracteres")
  @SafeInput(message = "Nome contém caracteres suspeitos")
  String name,

  @NotBlank(message = "Este campo é obrigatório!")
  @Pattern(regexp = "^[a-zA-ZÀ-ÿ\\s'\\-]{2,100}$", message = "Sobrenome inválido. Use apenas letras, espaços, hífens e apóstrofos")
  ...
  @Pattern(regexp = "^[a-zA-Z0-9À-ÿ\\s@._/:\\-,;|]*$", message = "Redes sociais contém caracteres inválidos")
