...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<GenericModelResponse> handleValidationExceptions(MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity.badRequest().body(GenericModelResponse.builder()
    ...
    public ResponseEntity<GenericModelResponse> handleConstraintViolation(ConstraintViolationException ex) {
    ...
    public ResponseEntity<GenericModelResponse> handleIllegalArgumentException(IllegalArgumentException ex) {
    ...
    public ResponseEntity<GenericModelResponse> handleEmailAlreadyExists(EmailAlreadyExistsException ex) {
        log.warn("Email duplicado: {}", ex.getMessage());
        return ResponseEntity.status(HttpStatus.CONFLICT).body(GenericModelResponse.builder()
                .code("EMAIL_EXISTS")
                .message(ex.getMessage())
                .timestamp(Instant.now())
                .build());
    ...
    public ResponseEntity<GenericModelResponse> handleNotFound(NotFoundException ex) {
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(GenericModelResponse.builder()
                .code("NOT_FOUND")
                .message(ex.getMessage())
                .timestamp(Instant.now())
                .build());
    ...
    public ResponseEntity<GenericModelResponse> handleRuntimeException(RuntimeException ex) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(GenericModelResponse.builder()
                .code("RUNTIME_ERROR")
