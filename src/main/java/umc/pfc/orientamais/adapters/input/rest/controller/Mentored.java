...
public class Mentored {
  ...
  public ResponseEntity<MentoredModelResponse> updateMentored(
      @PathVariable UUID id, @Valid @RequestBody MentoredUpdateModelRequest request) {
  ...
  public ResponseEntity<GenericModelResponse> addMentorReview(
      @PathVariable UUID mentorId, @Valid @RequestBody MentorReviewRequest request) {
    return ResponseEntity.status(HttpStatus.CREATED)
        .body(mentorReviewUseCase.addMentorReview(mentorId, request));
  }
}
