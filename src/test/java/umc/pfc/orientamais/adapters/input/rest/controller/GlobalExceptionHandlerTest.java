...
class GlobalExceptionHandlerTest {
  ...
  void shouldHandleValidationExceptionWithMultipleFields() {
    MethodArgumentNotValidException exception =
        buildValidationException(List.of(emailFieldError, passwordFieldError));
  ...
  void shouldHandleValidationExceptionWithDuplicateFieldNamesKeepingFirstMessage() {
    MethodArgumentNotValidException exception =
        buildValidationException(List.of(duplicateFieldErrorFirst, duplicateFieldErrorSecond));
  ...
  void shouldHandleMethodArgumentTypeMismatchException() {
    MethodArgumentTypeMismatchException ex =
        new MethodArgumentTypeMismatchException(
            "abc", Integer.class, "age", null, new IllegalArgumentException("Tipo inválido"));
