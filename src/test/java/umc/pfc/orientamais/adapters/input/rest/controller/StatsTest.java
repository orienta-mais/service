...
class StatsTest {
    ...
    void shouldPropagateExceptionWhenCountMentoredsFails() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> statsController.countMentoreds());
    ...
    void shouldPropagateExceptionWhenCountByStateFails() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> statsController.countByState());
    ...
    void shouldPropagateExceptionWhenCountMentorsFails() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> statsController.countMentors());
    ...
    void shouldPropagateExceptionWhenCountLessonsFails() {
        when(lessonUseCase.countUpcomingAndUnavailabLessons()).thenThrow(new RuntimeException("lesson error"));

        RuntimeException exception = assertThrows(RuntimeException.class, () -> statsController.countUpcomingLessons());
