...
class LessonTest {
    ...
    void shouldPropagateExceptionWhenCreateLessonFails() {
        ...
        IllegalStateException exception = assertThrows(IllegalStateException.class, () -> lessonController.createLesson(createRequest));
    ...
    void shouldPropagateExceptionWhenListLessonByIdFails() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> lessonController.listLessonById("1"));
    ...
    void shouldPropagateExceptionWhenUpdateLessonFails() {
        when(lessonUseCase.updateLesson("1", updateRequest)).thenThrow(new IllegalArgumentException("invalid"));

        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class, () -> lessonController.updateLesson("1", updateRequest));
    ...
    void shouldPropagateExceptionWhenDeleteLessonFails() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> lessonController.deleteLesson("1"));
    ...
    void shouldListLessonsByMentorSuccessfully() {
        ...
        ResponseEntity<List<LessonDetailsModelResponse>> response = lessonController.listLessonById(mentorId);
    ...
    void shouldPropagateExceptionWhenListLessonsByMentorFails() {
        when(lessonUseCase.listLessonByMentorId(mentorId)).thenThrow(new RuntimeException("mentor error"));

        RuntimeException exception = assertThrows(RuntimeException.class, () -> lessonController.listLessonById(mentorId));
    ...
    void shouldListLessonsByMentoredSuccessfully() {
        when(lessonUseCase.listLessonByMentoredId(mentoredId)).thenReturn(List.of(lessonDetailsModelResponse));

        ResponseEntity<List<LessonDetailsModelResponse>> response = lessonController.listLessonByMentoredId(mentoredId);
    ...
    void shouldPropagateExceptionWhenListLessonsByMentoredFails() {
        when(lessonUseCase.listLessonByMentoredId(mentoredId)).thenThrow(new RuntimeException("mentored error"));

        RuntimeException exception = assertThrows(RuntimeException.class, () -> lessonController.listLessonByMentoredId(mentoredId));
    ...
    void shouldPropagateExceptionWhenRegisterMentoredFails() {
        when(lessonUseCase.registerMentored("lesson-123")).thenThrow(new RuntimeException("register error"));

        RuntimeException exception = assertThrows(RuntimeException.class, () -> lessonController.registerMentored("lesson-123"));
    ...
    void shouldListAllLessonsSuccessfully() {
        ...
        ResponseEntity<PagedModelResponse<LessonModelResponse>> response = lessonController.listLessons("Java", filterDate, "asc", 0, 10);
    ...
    void shouldReturnEmptyPagedResponseWhenNoLessonsFound() {
        ...
        when(lessonUseCase.listLesson("Kotlin", filterDate, "asc", 0, 10)).thenReturn(emptyPagedResponse);

        ResponseEntity<PagedModelResponse<LessonModelResponse>> response = lessonController.listLessons("Kotlin", filterDate, "asc", 0, 10);
    ...
    void shouldListLessonsWithNullFilters() {
        ...
        ResponseEntity<PagedModelResponse<LessonModelResponse>> response = lessonController.listLessons(null, null, "desc", 2, 5);
    ...
    void shouldPropagateExceptionWhenListingLessonsFails() {
        when(lessonUseCase.listLesson("Java", null, "asc", 0, 10)).thenThrow(new RuntimeException("list error"));

        RuntimeException exception = assertThrows(RuntimeException.class, () -> lessonController.listLessons("Java", null, "asc", 0, 10));
    ...
    void shouldValidatePresenceAndGenerateCertificateSuccessfully() {
        when(certificateUseCase.validatePresenceAndGenerateCertificate(lessonUuid, presenceRequest)).thenReturn(certificateCreatedResponse);

        ResponseEntity<GenericModelResponse> response = lessonController.validatePresence(lessonUuid, presenceRequest);
    ...
    void shouldPropagateExceptionWhenValidatePresenceFails() {
        when(certificateUseCase.validatePresenceAndGenerateCertificate(lessonUuid, presenceRequest)).thenThrow(new RuntimeException("validate error"));

        RuntimeException exception = assertThrows(RuntimeException.class, () -> lessonController.validatePresence(lessonUuid, presenceRequest));
    ...
    void shouldRegenerateCertificateSuccessfully() {
        ...
        ResponseEntity<GenericModelResponse> response = lessonController.regenerateCertificate(lessonUuid);
    ...
    void shouldPropagateExceptionWhenRegenerateCertificateFails() {
        when(certificateUseCase.regenerateCertificate(lessonUuid)).thenThrow(new RuntimeException("regenerate error"));

        RuntimeException exception = assertThrows(RuntimeException.class, () -> lessonController.regenerateCertificate(lessonUuid));
    ...
    void shouldPropagateExceptionWhenCountUpcomingLessonsFails() {
        when(lessonUseCase.countUpcomingAndUnavailabLessons()).thenThrow(new RuntimeException("count error"));

        RuntimeException exception = assertThrows(RuntimeException.class, () -> lessonController.countUpcomingLessons());
