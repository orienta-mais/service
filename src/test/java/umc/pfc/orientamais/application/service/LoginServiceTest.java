...
class LoginServiceTest {
  ...
  void setUp() {
    ...
    loginService =
        new LoginService(jwtProvider, refreshTokenRepository, authUserRepository, passwordEncoder);
  }
  ...
  void shouldThrowWhenEmailNotFound() {
    ...
    NotFoundException ex =
        assertThrows(
            NotFoundException.class, () -> loginService.login("email@invalido.com", "senha"));
  ...
  void shouldThrowWhenPasswordIncorrect() {
    ...
    NotFoundException ex =
        assertThrows(
            NotFoundException.class, () -> loginService.login(user.getEmail(), "senhaErrada"));
  ...
  void shouldThrowWhenRefreshTokenNotFound() {
    ...
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> loginService.refreshToken("Bearer invalid"));
  ...
  void shouldThrowWhenRefreshTokenExpired() {
    ...
    NotFoundException ex =
        assertThrows(
            NotFoundException.class, () -> loginService.refreshToken("Bearer refresh-token"));
