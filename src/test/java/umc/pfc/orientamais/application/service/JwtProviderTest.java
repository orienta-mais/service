...
class JwtProviderTest {
    ...
    void setUp() {
        ...
        mentorUser = new AuthUser(UUID.randomUUID(), "mentor@test.com", "password", AuthUserRole.MENTOR);
        mentoredUser = new AuthUser(UUID.randomUUID(), "mentored@test.com", "password", AuthUserRole.MENTORED);
    }
