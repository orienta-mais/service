...
class MentoredMapperTest {
  ...
  @InjectMocks private MentoredMapper mentoredMapper;
  ...
  void setUp() {
    ...
    updateRequest =
        new MentoredUpdateModelRequest(
            "New", "Name", LocalDate.of(2001, 6, 15), "@new", "New description", "RJ", "PT");
  }
  ...
  void entityListToResponseShouldReturnMappedItems() {
    ...
    List<MentoredModelResponse> responses =
        mentoredMapper.entityToResponse(List.of(mentored, other));
  ...
  void updateEntityFromRequestShouldIgnoreNullBasicFieldsButApplyOptionalOnes() {
    MentoredUpdateModelRequest partialRequest =
        new MentoredUpdateModelRequest(null, null, null, null, "Changed description", "BA", "US");
  ...
  void toCountByStateResponseShouldConvertRowsToDtos() {
    List<Object[]> rows = List.of(new Object[] {"SP", 5L}, new Object[] {"RJ", 3});
