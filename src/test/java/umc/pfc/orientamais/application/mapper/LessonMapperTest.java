...
class LessonMapperTest {
  ...
  @InjectMocks private LessonMapper lessonMapper;

  @Mock private CreateMeetingAdapter createMeetingAdapter;
  ...
  void requestToEntityWithCreateRequestPopulatesFieldsAndGeneratesLink() {
    ...
    assertEquals(
        createRequest.getDate().atTime(createRequest.getStartTime()), result.getStartTime());
  ...
  void requestToEntityWithUpdateRequestPopulatesFieldsAndId() {
    ...
    assertEquals(mentor.getId(), result.getMentor().getId());
    assertEquals(
        updateRequest.getDate().atTime(updateRequest.getStartTime()), result.getStartTime());
  ...
  void entityToDetailsResponseListHandlesMultipleLessons() {
    ...
    List<LessonDetailsModelResponse> responses =
        lessonMapper.entityToDetailsResponse(List.of(baseLesson, anotherLesson));
  ...
  void entityToDetailsResponseShouldThrowWhenMentorIsNull() {
    ...
    assertThrows(
        NullPointerException.class, () -> lessonMapper.entityToDetailsResponse(baseLesson));
  }
