...
class MentorMapperTest {
    ...
    void updateEntityFromRequestShouldIgnoreNullFields() {
        MentorUpdateModelRequest partial = new MentorUpdateModelRequest(
                null,
                null,
                null,
                "@partial",
    ...
    void entityToInfoResponseShouldAggregateMentorDetails() {
        List<MentorReviewResponse> reviews = List.of(
                new MentorReviewResponse(UUID.randomUUID(), mentor.getId(), UUID.randomUUID(), "Mentored", 5, 4, 3, 5, 4, "Great"),
                new MentorReviewResponse(UUID.randomUUID(), mentor.getId(), UUID.randomUUID(), "Another", 4, 4, 4, 4, 4, "Good")
        );
